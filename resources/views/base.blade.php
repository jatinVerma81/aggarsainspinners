                                            ...
                                            <ul class="nav nav-pills" id="mainNav">
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown">
                                                                <a href="quarterly">Quarterly financial results</a>
                                                            </li>
                                                        <li class="dropdown">
                                                            <a href="shareholding">Shareholding pattern</a>
                                                        </li>
                                                        <li class="dropdown">
                                                            <a href="policies">Policies and code of conduct</a>
                                                        </li>
                                                        <li class="dropdown">
                                                            <a href="board">Board of Directors and committee</a>
                                                        </li>   
          ...
          <div class="row mb-xl">
						<div class="col-md-4">
								...
								<div class="list-group" style="padding-top: 7px;">
									<a href="annualreport" class="list-group-item list-group-item-action list-group-item-secondary">Annual reports</a>
									<a href="quarterly" class="list-group-item list-group-item-action list-group-item-secondary">Quarterly financial results</a>
									<a href="shareholding" class="list-group-item list-group-item-action list-group-item-secondary">Shareholding pattern</a>
									<a href="policies" class="list-group-item list-group-item-action list-group-item-secondary">Policies and code of conduct</a>
									<a href="board" class="list-group-item list-group-item-action list-group-item-secondary">Board of Directors and committee</a>
